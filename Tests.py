...
t0 = time.time()
#prob = GG([9, 16, 11, 11, 15, 16, 11, 12, 13, 12], [[6, 2, 3, 9, 19, 13, 13, 7, 7, 6], [14, 8, 9, 17, 18, 12, 8, 6, 6, 4], [4, 12, 2, 2, 12, 9, 15, 0, 8, 6], [4, 1, 2, 15, 20, 4, 3, 3, 15, 20], [19, 11, 6, 19, 20, 14, 17, 18, 0, 20]], 80,[102, 23, 53, 116, 167], "exemploteste")
#prob = GG([63, 39, 36, 17, 41, 31, 46, 22, 18, 62], [[12, 19, 4, 9, 9, 3, 15, 13, 5, 6], [4, 17, 7, 4, 20, 14, 2, 7, 16, 6], [9, 13, 0, 6, 12, 10, 20, 6, 6, 9], [7, 4, 10, 17, 1, 10, 15, 17, 9, 8], [2, 19, 1, 1, 1, 16, 2, 4, 5, 20]], 84,[30, 256, 245, 274, 85], "exemploteste")
#prob = GG([5, 7, 8, 12, 6, 11, 5, 7, 7, 9], [[18, 2, 6, 12, 11, 11, 14, 2, 17, 20], [11, 11, 2, 19, 9, 10, 4, 20, 17, 16], [9, 6, 11, 0, 18, 17, 19, 9, 0, 6], [15, 20, 2, 20, 15, 19, 1, 14, 16, 1], [6, 6, 11, 20, 0, 18, 4, 1, 5, 10], [8, 0, 19, 4, 5, 7, 1, 1, 3, 10], [12, 8, 13, 8, 15, 6, 7, 20, 9, 1], [20, 19, 0, 2, 9, 16, 1, 10, 7, 8], [16, 6, 12, 12, 11, 2, 19, 20, 7, 7], [17, 10, 13, 5, 15, 7, 11, 11, 20, 3]], 53,[149, 398, 469, 187, 61, 99, 56, 47, 96, 234], "exemploteste")


prob = GG([4, 3, 2], [[10, 5, 3], [0, 5, 7]], 9, [7, 9], "teste1.txt") 
#prob = GG([4, 3, 2], [[10, 5, 3], [0, 5, 7], [7, 10, 6], [3, 0, 4]], 9, [7, 9, 10, 10], "teste1.txt") 
#prob = GG([12, 7, 4, 3, 2], [[15, 6, 10, 5, 3], [3, 7, 0, 5, 7], [0, 12, 7, 10, 6], [16, 6, 3, 0, 4]], 20, [20, 20, 20, 20], "teste1.txt") 
#prob = GG([12, 7, 4, 3, 2], [[15, 6, 10, 5, 3], [3, 7, 0, 5, 7], [0, 12, 7, 10, 6], [8, 13, 5, 16, 2],[3, 1, 0, 0, 5], [10, 7, 0, 5, 7], [0, 12, 7, 10, 6], [16, 15, 6, 0, 12]], 20, [20, 20, 20, 20, 20, 20, 20, 20], "teste1.txt") 
print time.time() - t0,
